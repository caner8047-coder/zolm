<div class="space-y-6 overflow-x-hidden">
    ...
    @if($this->reports->isEmpty())
        <div class="text-center py-12">
            ...
            <button wire:click="switchTab('analyze')" class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm min-h-[44px]">
                Yeni Analiz Başlat
            </button>
        </div>
    @else
            ...
            @foreach($this->reports as $rpt)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition p-4 lg:p-5">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-center bg-gray-50 rounded-lg p-3 mb-3">
                        ...
                        <div>
                            <div class="text-xs text-indigo-500">Fırsat</div>
                            <div class="text-lg font-bold text-indigo-600">{{ $rpt->opportunity_count }}</div>
                        </div>
                        <div>
