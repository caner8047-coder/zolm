<div class="h-[calc(100vh-8rem)] flex flex-col">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">bu chat bot sistemdeki verilerle beslenmektedir. aldığı her komutu aldığı her görevi veya aldığı her soruyu önce anlar sistemdeki sipariş xls çıktılarını inceler ve ai sayesinde profesyonelce yorumlar</p>
    </div>
    ...
    <div class="mb-4">
        <select wire:model.live="selectedReportId" class="px-4 py-2 border border-gray-300 rounded-lg text-sm">
