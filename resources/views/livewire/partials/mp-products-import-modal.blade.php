                    ...
                    @if(!$importResult)
                        ...
                        @if($importFile)
                            <div class="mt-3 flex items-center gap-2 p-3 bg-indigo-50 rounded-lg">
                                ...
                                <span class="text-sm text-indigo-800 font-medium truncate">{{ $importFile->getClientOriginalName() }}</span>
                            </div>
                        @endif
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="bg-emerald-50 rounded-lg p-3">
                                    <p class="text-2xl font-bold text-emerald-700">{{ $importResult['imported'] }}</p>
                            ...
                            <div class="mt-4 text-left bg-red-50 rounded-lg p-3 max-h-32 overflow-y-auto">
                                ...
                                @if(count($importResult['errors']) > 5)
                                    <p class="text-xs text-red-400 mt-1">... ve {{ count($importResult['errors']) - 5 }} hata daha</p>
                                @endif
                            </div>
                            @endif
                        </div>
