                            ...
                            <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative flex justify-between">
                                        ...
                                        <!-- Vade/Hakediş -->
                                        <div>
                                            <div class="h-8 w-8 rounded-full {{ $set ? ($set['due_date'] ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-400') : 'bg-gray-100 text-gray-400' }} flex items-center justify-center ring-4 ring-white shadow" title="{{ !$set ? 'Ödeme Detay Exceli Yüklenmemiş' : '' }}">
                                            ...
                                            <div class="mt-3 hidden sm:block text-center">
                                                ...
                                                @if($set)
                                                    <span class="text-xs text-gray-500">{{ $set['due_date'] ?? 'Hesaplanmadı' }}</span>
                                                @else
                                        ...
                                        <!-- Bankaya Yatan -->
                                        <div>
                                            <div class="h-8 w-8 rounded-full {{ $set && $set['settlement_date'] ? 'bg-emerald-500 text-white' : 'bg-gray-100 text-gray-400' }} flex items-center justify-center ring-4 ring-white shadow" title="{{ !$set ? 'Ödeme Detay Exceli Yüklenmemiş' : '' }}">
                                            ...
                                            <div class="mt-3 hidden sm:block text-right">
                                                ...
                                                @if($set)
                                                    <span class="text-xs text-gray-500">{{ $set['settlement_date'] ?? 'Henüz Yatmadı' }}</span>
                                                @else
                                ...
                                <div class="bg-red-50 p-5 rounded-xl border border-red-200 shadow-sm">
                                    ...
                                    <ul class="space-y-3">
                                        @foreach($order['audits'] as $audit)
                                            <li class="bg-white p-3 rounded shadow-sm border-l-4 {{ $audit['severity'] === 'critical' ? 'border-red-600' : 'border-orange-400' }}">
                                                <p class="text-sm font-bold text-gray-900">{{ $audit['title'] }}</p>
                                                <p class="text-xs text-gray-600 mt-1">{{ $audit['description'] }}</p>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
