...
<div class="w-full space-y-4 lg:space-y-6">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
        <!-- Pilot Operasyon Merkezi -->
        <div class="rounded-[10px] border border-slate-200 bg-slate-50/50 p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div>
                <div class="flex items-center justify-between">
                    <span class="p-2 bg-slate-900 text-white rounded-lg">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.9" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                    </span>
                    <span class="px-2 py-0.5 text-xs font-semibold rounded bg-slate-900 text-white">Pilot Araçları</span>
                </div>
                <h3 class="mt-4 text-base font-semibold text-slate-900">Pilot Merkezi</h3>
                <p class="mt-2 text-sm text-slate-500">Pilot sağlığı (Health Check), UAT test kontrol listeleri, canlı pilot geri bildirimleri ve MVP risk sicil yönetimi.</p>
            </div>
            <div class="mt-6">
                <a href="{{ route('accounting.pilot-center') }}" class="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-slate-900 rounded-[6px] hover:bg-slate-800 transition-colors">
                    Aç
                </a>
            </div>
        </div>
        ...
        <!-- Tahsilat & Ödeme Merkezi -->
        <div class="rounded-[10px] border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div>
                <div class="flex items-center justify-between">
                    <span class="p-2 bg-emerald-50 text-emerald-700 rounded-lg">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.9" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                    </span>
                    <span class="px-2 py-0.5 text-xs font-semibold rounded bg-emerald-100 text-emerald-800">Hazır (MVP)</span>
                </div>
                <h3 class="mt-4 text-base font-semibold text-slate-900">Tahsilat & Ödeme</h3>
                <p class="mt-2 text-sm text-slate-500">Müşteri tahsilatları, tedarikçi ödemeleri, açık fatura kapatma ve kasa/banka entegrasyonu.</p>
            </div>
            <div class="mt-6">
                <a href="{{ route('accounting.collections-payments') }}" class="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-slate-900 rounded-[6px] hover:bg-slate-800 transition-colors">
                    Yönet
                </a>
            </div>
        </div>
