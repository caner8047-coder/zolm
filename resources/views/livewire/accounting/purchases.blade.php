    ...
    @if($showCreateForm)
        <section class="rounded-[10px] border border-slate-200 bg-white p-4 shadow-sm lg:p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">Tedarikçi (Cari)</label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">Belge / Fatura No</label>
                    <input type="text" wire:model="documentNumber" placeholder="Örn: ALI-2026-0001" class="mt-1 block w-full rounded-[6px] border border-slate-200 bg-white px-3 py-2 text-base sm:text-sm focus:border-slate-500 focus:outline-none min-h-[44px]" />
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" wire:model="description" placeholder="Satın alma siparişi açıklamaları..." class="mt-1 block w-full rounded-[6px] border border-slate-200 bg-white px-3 py-2 text-base sm:text-sm focus:border-slate-500 focus:outline-none min-h-[44px]" />
                </div>
            </div>
            ...
            <div class="flex justify-end gap-2 border-t border-slate-100 pt-4 mt-6">
                ...
                <button type="button" wire:click="createPurchaseOrder" class="px-4 py-2 text-sm font-medium text-white bg-slate-900 rounded-[6px] hover:bg-slate-800 min-h-[44px]">
                    Taslağı Kaydet
                </button>
            </div>
        </section>
            ...
            <table class="w-full border-collapse text-left text-sm text-slate-600 min-w-[800px]">
                <thead>
                    <tr class="border-b border-slate-200 text-xs font-semibold text-slate-500 uppercase tracking-wider bg-slate-50/50">
                        ...
                        <th class="p-4">Tedarikçi / Cari</th>
