...
class ShiftTemplateForm extends Component
{
    ...
    public function mount(?int $id = null): void
    {
        ...
        foreach (['code', 'name', 'starts_at', 'ends_at', 'break_minutes', 'crosses_midnight', 'color', 'is_active'] as $field) $this->{$field} = $template->{$field};
    ...
    public function save(): void
    {
        ...
        $data = $this->validate(['code' => 'required|string|max:40', 'name' => 'required|string|max:120', 'starts_at' => 'required|date_format:H:i', 'ends_at' => 'required|date_format:H:i', 'break_minutes' => 'required|integer|min:0|max:720', 'crosses_midnight' => 'boolean', 'color' => ['required', 'regex:/^#[0-9A-Fa-f]{6}$/'], 'is_active' => 'boolean']);
    ...
    public function render() { return view('livewire.hr.shift.shift-template-form')->layout('layouts.app'); }
}
