...
class LeaveRequestForm extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.hr.leave.leave-request-form', ['employees' => HrEmployee::withoutGlobalScope('tenant')->where('legal_entity_id', $tenantId)->active()->orderBy('first_name')->get(), 'leaveTypes' => HrLeaveType::withoutGlobalScope('tenant')->where('legal_entity_id', $tenantId)->where('is_active', true)->orderBy('name')->get(), 'documents' => $documents])->layout('layouts.app');
    }
}
