...
class PayrollWorkspace extends Component
{
 ...
 public function calculate(CalculatePayrollPeriodAction $action):void{$action->execute($this->payrollPeriod($this->selectedPeriodId));session()->flash('success','Brüt–net hesap tamamlandı; hesap izi ve vergi matrahı hareketleri kaydedildi.');}
