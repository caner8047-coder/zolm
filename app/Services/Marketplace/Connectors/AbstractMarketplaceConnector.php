...
abstract class AbstractMarketplaceConnector implements MarketplaceConnector, ReceivesWebhooks, TestsConnection
{
    ...
    public function capabilities(): array
    {
        return [
            ...
            'claim_approve'             => false,
            'claim_reject'              => false,
            // P0 salt-okuma genişletme capability'leri
            'reference_categories_pull' => false,
            'reference_attributes_pull' => false,
            'reference_brands_pull'     => false,
            'catalog_products_pull'     => false,
            'pending_orders_pull'       => false,
            'batch_status_pull'         => false,
        ];
    }
    ...
    protected function catalogDeliveryTermData(array ...$payloads): array
    {
        $days = $this->firstDeliveryPayloadValue($payloads, [
            ...
            'deliveryOptions.deliveryDuration',
            'delivery_duration',
            'delivery.duration',
        ...
        $fastDeliveryType = $this->firstDeliveryPayloadValue($payloads, [
            ...
            'fastDeliveryOption',
            'fastDelivery',
            'deliveryOption.fastDeliveryType',
            'deliveryOptions.fastDeliveryType',
            'deliveryOptions.fastDeliveryOptions.0.deliveryOptionType',
            'deliveryOptions.isRushDelivery',
