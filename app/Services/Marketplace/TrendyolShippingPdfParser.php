...
class TrendyolShippingPdfParser
{
    ...
    {
        $this->scriptPath = base_path('scripts/parse_shipping_pdf.py');
    }
    ...
    public function parse(string $pdfPath): array
    {
        ...
        if (! is_array($decoded)) {
            Log::warning('TrendyolShippingPdfParser: JSON decode hatası', [
    ...
    {
        Log::warning('TrendyolShippingPdfParser: ' . $msg);
