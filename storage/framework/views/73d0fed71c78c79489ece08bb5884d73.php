<div class="space-y-4 lg:space-y-6">
    ...
    <!-- System Messages -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('sync_message')): ?>
        <div class="rounded-md bg-green-50 p-4 border border-green-200">
            <div class="flex">
                ...
                <div class="ml-3"><p class="text-sm font-medium text-green-800"><?php echo e(session('sync_message')); ?></p></div>
            </div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importMessage): ?>
        <div class="rounded-md bg-blue-50 p-4 border border-blue-200 mb-4">
            <div class="flex">
                ...
                <div class="ml-3"><p class="text-sm text-blue-700"><?php echo e($importMessage); ?></p></div>
            </div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="bg-white rounded-lg shadow p-3 lg:p-4 border-l-4 border-indigo-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg lg:text-xl font-bold text-gray-900"><?php echo e(number_format($stats['total_orders'])); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-3 lg:p-4 border-l-4 border-green-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg lg:text-xl font-bold text-gray-900">₺<?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-3 lg:p-4 border-l-4 border-amber-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg lg:text-xl font-bold text-gray-900">₺<?php echo e(number_format($stats['avg_order_value'], 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <div class="flex items-center space-x-2 mt-1 flex-wrap">
                        <span class="inline-flex items-center text-xs"><span class="w-2 h-2 rounded-full bg-green-500 mr-1"></span><?php echo e($stats['delivered']); ?></span>
                        <span class="inline-flex items-center text-xs"><span class="w-2 h-2 rounded-full bg-yellow-500 mr-1"></span><?php echo e($stats['in_transit']); ?></span>
                        <span class="inline-flex items-center text-xs"><span class="w-2 h-2 rounded-full bg-red-500 mr-1"></span><?php echo e($stats['cancelled']); ?></span>
                        <span class="inline-flex items-center text-xs"><span class="w-2 h-2 rounded-full bg-orange-500 mr-1"></span><?php echo e($stats['returned']); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-2 block font-medium"><?php echo e($message); ?></span> <?php unset($message);
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-4">
            ...
            <div>
                <select wire:model.live="statusFilter" class="min-h-[44px] block w-full pl-3 pr-10 py-2 border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base sm:text-sm rounded-md">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $uniqueStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-4">
                ...
                <div>
                    ...
                    <select wire:model.live="cityFilter" class="min-h-[44px] block w-full pl-3 pr-10 py-2 border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base sm:text-sm rounded-md">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $uniqueCities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <div>
                    ...
                    <select wire:model.live="brandFilter" class="min-h-[44px] block w-full pl-3 pr-10 py-2 border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base sm:text-sm rounded-md">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $uniqueBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            ...
            <div class="lg:hidden bg-white shadow rounded-lg mb-3 overflow-hidden border border-gray-100">
                ...
                <div class="p-3 cursor-pointer active:bg-gray-50 transition-colors"
                     @click="expanded.includes(<?php echo e($order->id); ?>) ? expanded = expanded.filter(i => i !== <?php echo e($order->id); ?>) : expanded.push(<?php echo e($order->id); ?>)">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 flex-shrink-0 text-gray-400 transform transition-transform"
                                     :class="{ 'rotate-90 text-indigo-500': expanded.includes(<?php echo e($order->id); ?>) }"
                                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                                <span class="font-semibold text-indigo-600 text-sm"><?php echo e($order->order_number); ?></span>
                            </div>
                            <div class="text-xs text-gray-500 mt-0.5 ml-6"><?php echo e($order->order_date ? $order->order_date->format('d M Y - H:i') : '-'); ?></div>
                        </div>
                        <div class="flex flex-col items-end gap-1 flex-shrink-0">
                            <span class="px-2 py-0.5 text-xs font-semibold rounded-full <?php echo e($color); ?>">
                                <?php echo e($order->status ?? 'Durum Yok'); ?>

                            </span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alert['type']): ?>
                                <span class="px-2 py-0.5 text-[10px] font-bold rounded-full border <?php echo e($alert['color']); ?> flex items-center gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alert['type'] === 'iade'): ?>
                    ...
                    <div class="mt-2 ml-6 flex items-center justify-between gap-2">
                        <div class="min-w-0 flex-1">
                            <div class="font-medium text-gray-900 text-sm truncate"><?php echo e($order->customer_name ?? 'Bilinmiyor'); ?></div>
                            <div class="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                                ...
                                <span class="truncate"><?php echo e($order->customer_city); ?><?php echo e($order->customer_district ? ', ' . $order->customer_district : ''); ?></span>
                            </div>
                        </div>
                        <div class="text-right flex-shrink-0">
                            <div class="font-bold text-gray-900 text-sm">₺<?php echo e(number_format($order->total_gross_amount, 2, ',', '.')); ?></div>
                            <div class="text-xs text-indigo-600 font-medium"><?php echo e($order->items->count()); ?> Ürün</div>
                        </div>
                    </div>

                    <!-- Alt: Kargo + Muhasebe (varsa) -->
                    <div class="mt-2 ml-6 flex items-center justify-between gap-2">
                        <span class="bg-gray-100 text-gray-700 text-[11px] px-2 py-0.5 rounded border border-gray-200"><?php echo e($order->cargo_company ?? '-'); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->is_corporate_invoice === 'Evet'): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasFinancial): ?>
                            <span class="text-xs font-bold <?php echo e($netProfit >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                ...
                <!-- Mobil Detay Paneli -->
                <div x-show="expanded.includes(<?php echo e($order->id); ?>)"
                    ...
                    <div class="p-3 space-y-3">
                        <?php echo $__env->make('livewire.partials.marketplace-order-detail', ['order' => $order, 'hasFinancial' => $hasFinancial, 'netProfit' => $netProfit], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            ...
                            ?>
                            <!-- MASTER ROW -->
                            <tr class="hover:bg-gray-50 cursor-pointer transition-colors" @click="expanded.includes(<?php echo e($order->id); ?>) ? expanded = expanded.filter(i => i !== <?php echo e($order->id); ?>) : expanded.push(<?php echo e($order->id); ?>)">
                                ...
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <div class="font-medium text-indigo-600"><?php echo e($order->order_number); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->package_number): ?>
                                        <div class="text-gray-400 text-[10px] font-mono">PKT: <?php echo e($order->package_number); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="text-gray-500 text-xs mt-0.5"><?php echo e($order->order_date ? $order->order_date->format('d M Y - H:i') : '-'); ?></div>
                                </td>
                                <td class="px-3 py-4">
                                    <div class="font-medium text-gray-900"><?php echo e($order->customer_name ?? 'Bilinmiyor'); ?></div>
                                    <div class="text-gray-500 flex items-center space-x-1 mt-0.5 text-xs">
                                        ...
                                        <span><?php echo e($order->customer_city); ?><?php echo e($order->customer_district ? ', ' . $order->customer_district : ''); ?></span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->is_corporate_invoice === 'Evet'): ?>
                                ...
                                <td class="px-3 py-4">
                                    <span class="bg-gray-100 text-gray-800 text-xs px-2 py-0.5 rounded border border-gray-200"><?php echo e($order->cargo_company ?? '-'); ?></span>
                                    <div class="text-gray-500 text-xs mt-1 truncate max-w-[140px]" title="<?php echo e($order->tracking_number); ?>">
                                        <?php echo e($order->tracking_number ?? 'Takip No Yok'); ?>

                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->cargo_delivery_date): ?>
                                        <div class="text-[10px] text-gray-400 mt-0.5">Kargoya: <?php echo e($order->cargo_delivery_date->format('d/m')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="px-3 py-4 whitespace-nowrap text-right">
                                    <div class="font-semibold text-gray-900">₺<?php echo e(number_format($order->total_gross_amount, 2, ',', '.')); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->total_discount > 0): ?>
                                        <div class="text-red-500 text-xs">-₺<?php echo e(number_format($order->total_discount, 2, ',', '.')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="text-indigo-600 text-xs font-semibold mt-0.5">
                                        <?php echo e($order->items->count()); ?> Ürün
                                    </div>
                                </td>
                                <td class="px-3 py-4 whitespace-nowrap text-right">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasFinancial): ?>
                                        <div class="text-xs text-gray-500">Hakediş</div>
                                        <div class="font-semibold text-gray-900 text-sm">₺<?php echo e(number_format($netHakedis, 2, ',', '.')); ?></div>
                                        <div class="mt-0.5 <?php echo e($netProfit >= 0 ? 'text-green-600' : 'text-red-600'); ?> text-xs font-bold">
                                            <?php echo e($netProfit >= 0 ? '+' : ''); ?>₺<?php echo e(number_format($netProfit, 2, ',', '.')); ?>

                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alert['type']): ?>
                                            <span class="mt-1 inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[10px] font-bold border <?php echo e($alert['color']); ?>">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alert['type'] === 'iade'): ?>
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>
                                                <?php elseif($alert['type'] === 'ceza'): ?>
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>
                                ...
                                <td class="px-3 py-4 whitespace-nowrap">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->alt_delivery_status): ?>
                                        <div class="text-[10px] text-gray-400 mt-0.5 truncate max-w-[100px]" title="<?php echo e($order->alt_delivery_status); ?>"><?php echo e($order->alt_delivery_status); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                            </tr>

                            <!-- ═══════════ DETAY PANELİ (Desktop) ═══════════ -->
                            <tr x-show="expanded.includes(<?php echo e($order->id); ?>)" class="bg-slate-50/50"
                                x-transition:enter="transition ease-out duration-200"
...
<?php /**PATH /var/www/html/resources/views/livewire/marketplace-orders.blade.php ENDPATH**/ ?>