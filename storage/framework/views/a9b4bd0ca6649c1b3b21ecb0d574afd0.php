...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="rounded-lg p-4 <?php echo e($messageType === 'success' ? 'bg-green-50 border border-green-200 text-green-700' : ($messageType === 'error' ? 'bg-red-50 border border-red-200 text-red-700' : 'bg-blue-50 border border-blue-200 text-blue-700')); ?>">
                <?php echo e($message); ?>
        ...
        <div class="space-y-4 lg:space-y-6">
            <!-- New Profile Button -->
            <a href="<?php echo e(route('profile.wizard')); ?>" class="block w-full px-4 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors text-center">
                ✨ AI ile Yeni Profil
            </a>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                ...
                <a href="<?php echo e(route('reports')); ?>" class="block w-full px-4 py-2 text-sm text-center border border-gray-300 rounded-lg hover:bg-gray-50">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <button 
                    ...
                    <?php echo e($isSaving ? 'disabled' : ''); ?>

                >
                    <span wire:loading.remove wire:target="saveAllToHistory">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSaving): ?>
...
<?php /**PATH C:\laragon\www\zolm\resources\views/livewire/operation-motor.blade.php ENDPATH**/ ?>