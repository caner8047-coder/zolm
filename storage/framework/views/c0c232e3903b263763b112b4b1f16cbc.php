<div class="px-4 lg:px-6 py-6 mx-auto max-w-7xl" x-data="{ viewMode: 'table' }">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($s['total'])); ?></p>
                </div>
            ...
            <p class="text-xs text-gray-400 mt-2"><?php echo e($s['active']); ?> aktif · <?php echo e($s['out_of_stock']); ?> tükenen</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs sm:text-sm font-medium text-gray-500">Toplam Stok</p>
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($s['total_stock'])); ?></p>
                </div>
            ...
            <p class="text-xs text-gray-400 mt-2">Stok değeri: <?php echo e(number_format($s['stock_value'], 0, ',', '.')); ?> ₺</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs sm:text-sm font-medium text-gray-500">Ort. Maliyet</p>
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(number_format($s['avg_cogs'], 2, ',', '.')); ?> ₺</p>
                </div>
                <div class="w-10 h-10 bg-amber-50 rounded-lg flex items-center justify-center">
                    <svg class="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
            </div>
            <p class="text-xs text-gray-400 mt-2"><?php echo e($s['with_cost']); ?> tanımlı · <?php echo e($s['without_cost']); ?> eksik</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs sm:text-sm font-medium text-gray-500">Maliyet Kapsam</p>
                    <p class="text-2xl font-bold <?php echo e($s['total'] > 0 && ($s['with_cost'] / $s['total'] * 100) >= 80 ? 'text-emerald-600' : 'text-amber-600'); ?> mt-1">
                        %<?php echo e($s['total'] > 0 ? round($s['with_cost'] / $s['total'] * 100) : 0); ?>
    ...
    <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-3 mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <span class="text-sm font-medium text-indigo-800"><?php echo e(count($selectedProducts)); ?> ürün seçildi</span>
        <div class="flex gap-2">
            ...
            <button wire:click="bulkDelete" wire:confirm="Seçili <?php echo e(count($selectedProducts)); ?> ürünü silmek istediğinize emin misiniz?" class="px-3 py-1.5 text-xs font-medium bg-red-100 text-red-700 rounded-md hover:bg-red-200">Sil</button>
        </div>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50/80 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-4 py-3 font-semibold cursor-pointer hover:text-indigo-600" wire:click="sortBy('product_name')">
                            Ürün
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'product_name'): ?> <span><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                        <th class="px-4 py-3 font-semibold text-right cursor-pointer hover:text-indigo-600" wire:click="sortBy('sale_price')">
                            Fiyat
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'sale_price'): ?> <span><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                        <th class="px-4 py-3 font-semibold text-right cursor-pointer hover:text-indigo-600" wire:click="sortBy('cogs')">
                            COGS
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'cogs'): ?> <span><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                        <th class="px-4 py-3 font-semibold text-center cursor-pointer hover:text-indigo-600" wire:click="sortBy('stock_quantity')">
                            Stok
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'stock_quantity'): ?> <span><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-3"><input type="checkbox" value="<?php echo e($p->id); ?>" wire:model.live="selectedProducts" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"></td>
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->main_image): ?>
                                    <img src="<?php echo e($p->main_image); ?>" alt="" class="w-10 h-10 rounded-lg object-cover border border-gray-200 flex-shrink-0">
                                <?php else: ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="min-w-0">
                                    <div class="font-medium text-gray-900 truncate max-w-[240px]"><?php echo e($p->product_name ?? 'İsimsiz Ürün'); ?></div>
                                    <div class="text-xs text-gray-500 flex items-center gap-2 mt-0.5">
                                        <span title="Barkod"><?php echo e($p->barcode); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->stock_code && $p->stock_code !== $p->barcode): ?>
                                            <span class="text-gray-300">·</span>
                                            <span title="Stok Kodu"><?php echo e($p->stock_code); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->category_name): ?>
                                        <span class="text-xs text-indigo-600"><?php echo e($p->category_name); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="px-4 py-3 text-right">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->sale_price > 0): ?>
                                <div class="font-medium text-gray-900"><?php echo e(number_format($p->sale_price, 2, ',', '.')); ?> ₺</div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->commission_rate > 0): ?>
                                    <div class="text-xs text-gray-400">%<?php echo e(number_format($p->commission_rate, 1)); ?> kom.</div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                        ...
                        <td class="px-4 py-3 text-right">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->cogs > 0): ?>
                                <div class="font-medium text-gray-900"><?php echo e(number_format($p->cogs, 2, ',', '.')); ?> ₺</div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->packaging_cost > 0): ?>
                                    <div class="text-xs text-gray-400">+<?php echo e(number_format($p->packaging_cost, 2, ',', '.')); ?> ambalaj</div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($p->stock_level_color); ?>">
                                <?php echo e(number_format($p->stock_quantity)); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($p->vat_rate == 10 ? 'bg-blue-100 text-blue-800' : ($p->vat_rate == 1 ? 'bg-purple-100 text-purple-800' : 'bg-orange-100 text-orange-800')); ?>">
                                %<?php echo e(number_format($p->vat_rate, 0)); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($p->status_color); ?>">
                                <?php echo e($p->status_label); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            <button wire:click="editProduct(<?php echo e($p->id); ?>)" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium mr-2">Düzenle</button>
                            <button wire:click="deleteProduct(<?php echo e($p->id); ?>)" wire:confirm="Bu ürünü silmek istediğinize emin misiniz?" class="text-red-600 hover:text-red-900 text-sm font-medium">Sil</button>
                        </td>
                    </tr>
    ...
    <div x-show="viewMode === 'card'" class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-4 mb-4">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 hover:shadow-md transition-shadow">
            <div class="flex items-start gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->main_image): ?>
                    <img src="<?php echo e($p->main_image); ?>" alt="" class="w-14 h-14 rounded-lg object-cover border border-gray-200 flex-shrink-0">
                <?php else: ?>
                ...
                <div class="flex-1 min-w-0">
                    <h3 class="font-medium text-gray-900 text-sm truncate"><?php echo e($p->product_name ?? 'İsimsiz'); ?></h3>
                    <p class="text-xs text-gray-500 mt-0.5"><?php echo e($p->barcode); ?></p>
                    <div class="flex items-center gap-1.5 mt-1">
                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium <?php echo e($p->status_color); ?>"><?php echo e($p->status_label); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->category_name): ?>
                            <span class="text-xs text-indigo-600"><?php echo e($p->category_name); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
            ...
            <div class="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-gray-100">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900"><?php echo e($p->sale_price > 0 ? number_format($p->sale_price, 0, ',', '.') . ' ₺' : '—'); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">COGS</p>
                    <p class="text-sm font-medium <?php echo e($p->cogs > 0 ? 'text-gray-900' : 'text-amber-600'); ?>"><?php echo e($p->cogs > 0 ? number_format($p->cogs, 0, ',', '.') . ' ₺' : 'Eksik'); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Stok</p>
                    <p class="text-sm font-medium"><span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs <?php echo e($p->stock_level_color); ?>"><?php echo e(number_format($p->stock_quantity)); ?></span></p>
                </div>
            </div>
            <div class="flex justify-end gap-2 mt-3">
                <button wire:click="editProduct(<?php echo e($p->id); ?>)" class="text-xs text-indigo-600 hover:text-indigo-900 font-medium">Düzenle</button>
                <button wire:click="deleteProduct(<?php echo e($p->id); ?>)" wire:confirm="Bu ürünü silmek istediğinize emin misiniz?" class="text-xs text-red-600 hover:text-red-900 font-medium">Sil</button>
            </div>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <?php echo $__env->make('livewire.partials.mp-products-edit-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('livewire.partials.mp-products-import-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php /**PATH C:\laragon\www\zolm\resources\views/livewire/mp-products-manager.blade.php ENDPATH**/ ?>