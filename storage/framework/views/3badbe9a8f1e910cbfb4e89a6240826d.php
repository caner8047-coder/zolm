<div>
    ...
    <div class="p-4 lg:p-6 bg-white border-b border-gray-200">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                <select wire:model.live="selectedYear" class="px-3 py-2 border rounded-lg text-base sm:text-sm bg-white">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($y = 2024; $y <= 2027; $y++): ?>
                ...
                <select wire:model.live="selectedMonth" class="px-3 py-2 border rounded-lg text-base sm:text-sm bg-white">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Ocak','Şubat','Mart','Nisan','Mayıs','Haziran','Temmuz','Ağustos','Eylül','Ekim','Kasım','Aralık']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <option value="<?php echo e($i + 1); ?>"><?php echo e($ay); ?></option>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$selectedPeriodId): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($importStatus): ?>
            <div class="px-4 py-2 rounded-lg text-sm <?php echo e(str_starts_with($importStatus, '✅') ? 'bg-emerald-50 text-emerald-700' : (str_starts_with($importStatus, '❌') ? 'bg-red-50 text-red-700' : 'bg-blue-50 text-blue-700')); ?>">
    ...
    <div class="border-b border-gray-200 bg-white overflow-x-auto">
        <nav class="flex min-w-max px-4 lg:px-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                ...
                'orders'    => '📋 Siparişler',
                'settings'  => '⚙️ Ayarlar',
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <button wire:click="$set('activeTab', '<?php echo e($tab); ?>')"
                    class="px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap
                           <?php echo e($activeTab === $tab ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                    <?php echo e($label); ?>
    ...
    <div class="p-4 lg:p-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'dashboard'): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPeriodId): ?>
                <?php $stats = $this->dashboardStats; ?>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['audit_count'] > 0): ?>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-red-700 text-xs lg:text-sm mt-1">
                                        Seçili dönemde <strong><?php echo e($stats['audit_count']); ?> adet</strong> işlemde
                                        <strong><?php echo e(number_format($stats['audit_amount'], 0, ',', '.')); ?> ₺</strong>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4 lg:gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
                        ...
                        <p class="text-xl lg:text-2xl font-bold text-gray-900">
                            <?php echo e(number_format($stats['total_brut'], 0, ',', '.')); ?> ₺
                        </p>
                        <p class="text-xs text-gray-500 mt-1">
                            <?php echo e($stats['total_orders']); ?> sipariş — <?php echo e($stats['return_rate']); ?>% iade
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
                        ...
                        <p class="text-xl lg:text-2xl font-bold text-indigo-600">
                            <?php echo e(number_format($stats['total_stopaj'], 0, ',', '.')); ?> ₺
                        </p>
                        <p class="text-xs text-gray-500 mt-1">
                    ...
                    <div class="bg-white rounded-xl border border-red-200 p-4 lg:p-5 shadow-sm">
                        ...
                        <p class="text-xl lg:text-2xl font-bold text-red-600">
                            -<?php echo e(number_format($stats['logistic_loss']['total'], 0, ',', '.')); ?> ₺
                        </p>
                        <p class="text-xs text-gray-500 mt-1">
                            Sunk: <?php echo e(number_format($stats['logistic_loss']['sunk_cargo'], 0, ',', '.')); ?> ₺ + Dönüş: <?php echo e(number_format($stats['logistic_loss']['return_cargo'], 0, ',', '.')); ?> ₺
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-4 lg:p-5 shadow-sm">
                        ...
                        <p class="text-xl lg:text-2xl font-bold <?php echo e($stats['net_vat']['net_vat'] > 0 ? 'text-orange-600' : 'text-emerald-600'); ?>">
                            <?php echo e($stats['net_vat']['net_vat'] > 0 ? '' : '+'); ?><?php echo e(number_format($stats['net_vat']['net_vat'], 0, ',', '.')); ?> ₺
                        </p>
                        <p class="text-xs text-gray-500 mt-1">
                            <?php echo e($stats['net_vat']['is_payable'] ? 'Devlete ödenecek' : 'KDV avantajı'); ?>

                        </p>
                    </div>

                    
                    <div class="rounded-xl border-2 p-4 lg:p-5 shadow-sm <?php echo e($stats['real_profit']['total_profit'] >= 0 ? 'bg-emerald-50 border-emerald-300' : 'bg-red-50 border-red-300'); ?>">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-xs font-semibold <?php echo e($stats['real_profit']['total_profit'] >= 0 ? 'text-emerald-600' : 'text-red-600'); ?> uppercase tracking-wider">Gerçek Net Kâr</span>
                            <span class="text-lg"><?php echo e($stats['real_profit']['total_profit'] >= 0 ? '📈' : '📉'); ?></span>
                        </div>
                        <p class="text-xl lg:text-2xl font-bold <?php echo e($stats['real_profit']['total_profit'] >= 0 ? 'text-emerald-700' : 'text-red-700'); ?>">
                            <?php echo e(number_format($stats['real_profit']['total_profit'], 0, ',', '.')); ?> ₺
                        </p>
                        <p class="text-xs <?php echo e($stats['real_profit']['total_profit'] >= 0 ? 'text-emerald-600' : 'text-red-600'); ?> mt-1">
                            <?php echo e($stats['real_profit']['profitable_count']); ?> kârlı, <?php echo e($stats['real_profit']['bleeding_count']); ?> zararlı ürün
                        </p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$stats['real_profit']['has_cogs']): ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-6">
                    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                        ...
                        <p class="text-lg font-bold text-gray-900"><?php echo e(number_format($stats['total_hakedis'], 0, ',', '.')); ?> ₺</p>
                    </div>
                    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                        <p class="text-xs text-gray-400 uppercase mb-1">İade Sayısı</p>
                        <p class="text-lg font-bold text-gray-900"><?php echo e($stats['total_returns']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($stats['return_rate']); ?>% iade oranı</p>
                    </div>
                    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                        <p class="text-xs text-gray-400 uppercase mb-1">İptal Sayısı</p>
                        <p class="text-lg font-bold text-gray-900"><?php echo e($stats['total_cancels']); ?></p>
                    </div>
                    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm <?php echo e($stats['audit_count'] > 0 ? 'border-red-200' : ''); ?>">
                        <p class="text-xs text-gray-400 uppercase mb-1">Denetim Uyarıları</p>
                        <p class="text-lg font-bold <?php echo e($stats['audit_count'] > 0 ? 'text-red-600' : 'text-gray-900'); ?>"><?php echo e($stats['audit_count']); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['audit_amount'] > 0): ?>
                            <p class="text-xs text-red-500"><?php echo e(number_format($stats['audit_amount'], 0, ',', '.')); ?> ₺ fark</p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->invoiceReconciliation): ?>
                    <?php $recon = $this->invoiceReconciliation; ?>
                    <div class="mt-6 mb-6 bg-white rounded-xl border <?php echo e(($recon['commission_match'] && $recon['cargo_match']) ? 'border-emerald-200' : 'border-amber-300'); ?> p-5 shadow-sm">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-sm font-bold text-gray-800 uppercase tracking-widest flex items-center gap-2">
                                <svg class="w-5 h-5 <?php echo e(($recon['commission_match'] && $recon['cargo_match']) ? 'text-emerald-500' : 'text-amber-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                Aylık Fatura Mutabakat Durumu
                            </h3>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recon['commission_match'] && $recon['cargo_match']): ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="p-4 rounded-lg bg-gray-50 border <?php echo e($recon['commission_match'] ? 'border-gray-200' : 'border-amber-200'); ?>">
                                ...
                                <div class="flex justify-between items-center mb-1">
                                    ...
                                    <span class="font-medium text-gray-900"><?php echo e(number_format($recon['invoice_commission'], 2, ',', '.')); ?> ₺</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Sipariş Toplamı (Netleştirilmiş):</span>
                                    <span class="font-medium text-gray-900"><?php echo e(number_format($recon['order_commission'], 2, ',', '.')); ?> ₺</span>
                                </div>
                                <div class="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
                                    <span class="text-xs font-semibold <?php echo e($recon['commission_match'] ? 'text-emerald-600' : 'text-amber-600'); ?>">
                                        <?php echo e($recon['commission_match'] ? 'Mutabık' : 'Uyuşmazlık'); ?>

                                    </span>
                                    <span class="text-sm font-bold <?php echo e($recon['commission_match'] ? 'text-gray-900' : 'text-red-600'); ?>">
                                        Fark: <?php echo e(number_format($recon['commission_diff'], 2, ',', '.')); ?> ₺
                                    </span>
                                </div>
                            </div>

                            
                            <div class="p-4 rounded-lg bg-gray-50 border <?php echo e($recon['cargo_match'] ? 'border-gray-200' : 'border-amber-200'); ?>">
                                <p class="text-xs font-bold text-gray-500 uppercase mb-3">Kargo Eşleştirmesi</p>
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm text-gray-600">Fatura Edilen (KDV Hariç):</span>
                                    <span class="font-medium text-gray-900"><?php echo e(number_format($recon['invoice_cargo'], 2, ',', '.')); ?> ₺</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Sipariş Toplamı (Netleştirilmiş):</span>
                                    <span class="font-medium text-gray-900"><?php echo e(number_format($recon['order_cargo'], 2, ',', '.')); ?> ₺</span>
                                </div>
                                <div class="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
                                    <span class="text-xs font-semibold <?php echo e($recon['cargo_match'] ? 'text-emerald-600' : 'text-amber-600'); ?>">
                                        <?php echo e($recon['cargo_match'] ? 'Mutabık' : 'Uyuşmazlık'); ?>

                                    </span>
                                    <span class="text-sm font-bold <?php echo e($recon['cargo_match'] ? 'text-gray-900' : 'text-red-600'); ?>">
                                        Fark: <?php echo e(number_format($recon['cargo_diff'], 2, ',', '.')); ?> ₺
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($stats['cash_flow']) && count($stats['cash_flow']['kanban']) > 0): ?>
                    <div class="mt-6 mb-2">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
                            ...
                            <span class="text-sm font-bold text-gray-900 bg-gray-100 px-4 py-1.5 rounded-full border border-gray-200 shadow-sm">
                                Toplam Beklenen: <?php echo e(number_format($stats['cash_flow']['total_expected'], 2, ',', '.')); ?> ₺
                            </span>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stats['cash_flow']['kanban']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kanban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
                                    <div class="absolute left-0 top-0 bottom-0 w-1.5 bg-<?php echo e($kanban['color']); ?>-500"></div>
                                    <div class="pl-2">
                                        <p class="text-xs font-bold text-<?php echo e($kanban['color']); ?>-600 uppercase mb-1"><?php echo e($kanban['label']); ?></p>
                                        <p class="text-xl lg:text-2xl font-bold text-gray-900"><?php echo e(number_format($kanban['amount'], 2, ',', '.')); ?> ₺</p>
                                        <p class="text-xs text-gray-500 mt-1"><?php echo e($kanban['count']); ?> adet işlem bekleniyor</p>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
        ...
        <div x-data="{
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('import_success')): ?>
                <div class="mb-6 p-4 bg-green-50 border border-green-200 text-green-800 rounded-lg flex items-center gap-3">
                    <span class="text-xl">✅</span>
                    <span class="font-medium"><?php echo e(session('import_success')); ?></span>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(session()->has('import_error')): ?>
                <div class="mb-6 p-4 bg-red-50 border border-red-200 text-red-800 rounded-lg flex items-center gap-3">
                    ...
                    <span class="font-medium"><?php echo e(session('import_error')); ?></span>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($importErrors) > 0): ?>
                <div class="mt-4 bg-red-50 border border-red-200 rounded-xl p-4">
                    <h4 class="text-sm font-medium text-red-800 mb-2">İşleme Hataları (<?php echo e(count($importErrors)); ?>)</h4>
                    <ul class="text-xs text-red-600 space-y-1 max-h-32 overflow-y-auto">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $importErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <?php elseif($activeTab === 'search'): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchResult !== null): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($searchResult) === 0): ?>
                ...
                <?php else: ?>
                    <div class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $searchResult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div wire:click="showOrderDetail(<?php echo e($result['id']); ?>)"
                                 class="bg-white rounded-xl border border-gray-200 p-4 cursor-pointer hover:shadow-md transition-shadow
                                        <?php echo e($result['is_flagged'] ? 'border-red-300 bg-red-50' : ''); ?>">
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                    <div class="flex-1 min-w-0">
                                        <p class="font-medium text-gray-900 truncate"><?php echo e($result['product_name']); ?></p>
                                        <p class="text-xs text-gray-500 mt-1">
                                            #<?php echo e($result['order_number']); ?> · <?php echo e($result['barcode']); ?> · <?php echo e($result['order_date']); ?> · <span class="font-medium text-blue-600"><?php echo e($result['period_name'] ?? ''); ?></span>
                                        </p>
                                    </div>
                                    <div class="flex flex-wrap items-center gap-2 flex-shrink-0 mt-2 sm:mt-0">
                                        <span class="px-2.5 py-1 text-xs font-semibold rounded-full <?php echo e($result['status_color']); ?> border border-opacity-20 shadow-sm">
                                            <?php echo e($result['status']); ?>

                                        </span>
                                        <span class="text-sm font-bold text-gray-900 ml-2">
                                            <?php echo e(number_format($result['gross_amount'], 2, ',', '.')); ?> ₺
                                        </span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result['is_flagged']): ?>
        ...
        <?php elseif($activeTab === 'audit'): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastAuditResult): ?>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                    <div class="bg-red-50 border border-red-200 rounded-xl p-4 text-center">
                        <p class="text-2xl font-bold text-red-600"><?php echo e($lastAuditResult['total_errors']); ?></p>
                        <p class="text-xs text-red-500">Kritik Hata</p>
                    </div>
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
                        <p class="text-2xl font-bold text-amber-600"><?php echo e($lastAuditResult['total_warnings']); ?></p>
                        <p class="text-xs text-amber-500">Uyarı</p>
                    </div>
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
                        <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format(abs($lastAuditResult['total_amount']), 0, ',', '.')); ?> ₺</p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLogs->isNotEmpty()): ?>
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="bg-white rounded-xl border p-4
                                    <?php echo e($log->severity === 'critical' ? 'border-red-300 bg-red-50' : ($log->severity === 'warning' ? 'border-amber-300 bg-amber-50' : 'border-blue-200 bg-blue-50')); ?>">
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-1">
                                        <span class="text-sm"><?php echo e($log->severity_icon); ?></span>
                                        <span class="px-2 py-0.5 text-xs font-mono rounded <?php echo e($log->severity === 'critical' ? 'bg-red-200 text-red-800' : ($log->severity === 'warning' ? 'bg-amber-200 text-amber-800' : 'bg-blue-200 text-blue-800')); ?>">
                                            <?php echo e($log->rule_code); ?>

                                        </span>
                                    </div>
                                    <p class="font-medium text-gray-900 text-sm"><?php echo e($log->title); ?></p>
                                    <p class="text-xs text-gray-600 mt-1 leading-relaxed"><?php echo e($log->description); ?></p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->difference > 0): ?>
                                    <span class="text-sm font-bold text-red-600 flex-shrink-0">
                                        <?php echo e(number_format($log->difference, 2, ',', '.')); ?> ₺
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
        ...
        <?php elseif($activeTab === 'profit'): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPeriodId): ?>
                <?php $profitItems = $this->profitData; ?>
                ...
                <div class="mb-4 p-3 rounded-lg border flex flex-col sm:flex-row sm:items-center justify-between gap-2
                    <?php echo e($cogsPct >= 90 ? 'bg-emerald-50 border-emerald-200' : ($cogsPct >= 70 ? 'bg-amber-50 border-amber-200' : 'bg-red-50 border-red-200')); ?>">
                    <div class="flex items-center gap-2">
                        <span class="text-sm"><?php echo e($cogsPct >= 90 ? '✅' : ($cogsPct >= 70 ? '⚠️' : '🚨')); ?></span>
                        <span class="text-sm font-medium <?php echo e($cogsPct >= 90 ? 'text-emerald-800' : ($cogsPct >= 70 ? 'text-amber-800' : 'text-red-800')); ?>">
                            COGS Kapsam: %<?php echo e($cogsPct); ?> (<?php echo e($cogsStats->with_cogs); ?>/<?php echo e($cogsStats->total); ?> ürün)
                        </span>
                    </div>
                    <a href="<?php echo e(route('mp.products')); ?>" class="text-xs font-medium text-indigo-600 hover:text-indigo-800 underline">
                        Ürünler sayfasında COGS gir →
                    </a>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($profitItems) > 0): ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mb-6">
                        <div class="flex-1 rounded-xl p-4 <?php echo e($totalProfit >= 0 ? 'bg-emerald-50 border border-emerald-200' : 'bg-red-50 border border-red-200'); ?>">
                            <p class="text-xs font-semibold <?php echo e($totalProfit >= 0 ? 'text-emerald-600' : 'text-red-600'); ?> uppercase">Toplam Net Kâr</p>
                            <p class="text-xl font-bold <?php echo e($totalProfit >= 0 ? 'text-emerald-700' : 'text-red-700'); ?>">
                        ...
                        <div class="flex-1 rounded-xl bg-white border border-gray-200 p-4">
                            ...
                            <p class="text-xl font-bold text-gray-900"><?php echo e(count($profitItems)); ?></p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bleedingTotal > 0): ?>
                            <div class="flex-1 rounded-xl bg-red-50 border border-red-200 p-4">
                                ...
                                <p class="text-xl font-bold text-red-700"><?php echo e($bleedingTotal); ?></p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700"
                                        ...
                                        Sipariş <?php echo e($profitSortBy === 'order_count' ? ($profitSortDir === 'asc' ? '↑' : '↓') : ''); ?>

                                    </th>
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700"
                                        wire:click="sortProfit('total_gross')">
                                        Ciro <?php echo e($profitSortBy === 'total_gross' ? ($profitSortDir === 'asc' ? '↑' : '↓') : ''); ?>

                                    </th>
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700"
                                        wire:click="sortProfit('total_hakedis')">
                                        Hakediş <?php echo e($profitSortBy === 'total_hakedis' ? ($profitSortDir === 'asc' ? '↑' : '↓') : ''); ?>
                                    ...
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700"
                                        ...
                                        Net Kâr <?php echo e($profitSortBy === 'total_net_profit' ? ($profitSortDir === 'asc' ? '↑' : '↓') : ''); ?>

                                    </th>
                                    <th class="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:text-gray-700"
                                        wire:click="sortProfit('avg_margin')">
                                        Margin <?php echo e($profitSortBy === 'avg_margin' ? ($profitSortDir === 'asc' ? '↑' : '↓') : ''); ?>

                                    </th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $profitItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="<?php echo e($item['is_bleeding'] ? 'bg-red-100 text-red-800' : 'hover:bg-gray-50'); ?>">
                                        <td class="px-3 py-3">
                                            <div class="min-w-0">
                                                <p class="text-sm font-medium truncate max-w-xs <?php echo e($item['is_bleeding'] ? 'text-red-900' : 'text-gray-900'); ?>">
                                                    <?php echo e($item['product_name']); ?>

                                                </p>
                                                <p class="text-xs <?php echo e($item['is_bleeding'] ? 'text-red-600' : 'text-gray-500'); ?>">
                                                    <?php echo e($item['barcode']); ?> · <?php echo e($item['stock_code']); ?>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$item['has_cogs']): ?> <span class="text-amber-500">⚠️ COGS yok</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-3 py-3 text-right text-sm"><?php echo e($item['order_count']); ?> (<?php echo e($item['total_quantity']); ?> ad.)</td>
                                        <td class="px-3 py-3 text-right text-sm font-medium"><?php echo e(number_format($item['total_gross'], 0, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-right text-sm"><?php echo e(number_format($item['total_hakedis'], 0, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-right text-sm"><?php echo e(number_format($item['total_cogs'], 0, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-right text-sm font-bold <?php echo e($item['is_bleeding'] ? 'text-red-800' : ($item['total_net_profit'] > 0 ? 'text-emerald-600' : 'text-gray-900')); ?>">
                                            <?php echo e(number_format($item['total_net_profit'], 0, ',', '.')); ?> ₺
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['is_bleeding']): ?>
                                                <span class="ml-1">🩸</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-3 py-3 text-right text-sm font-medium <?php echo e($item['avg_margin'] < 0 ? 'text-red-600' : ($item['avg_margin'] > 20 ? 'text-emerald-600' : 'text-gray-700')); ?>">
                                            %<?php echo e($item['avg_margin']); ?>
                ...
                <div class="flex flex-col gap-4 mb-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedOrders) > 0): ?>
                        <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-3 flex flex-col sm:flex-row items-center justify-between gap-4 mt-2 mb-2 shadow-sm animate-pulse-slow">
                            <div class="flex items-center gap-2">
                                <span class="bg-indigo-600 text-white text-xs font-bold px-2 py-1 rounded-full"><?php echo e(count($selectedOrders)); ?></span>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button wire:click="$set('advancedOrderFilter', 'all')" 
                                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-all <?php echo e($advancedOrderFilter === 'all' ? 'bg-gray-800 text-white border-gray-800 shadow-sm' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50'); ?>">
                            Tümü
                        </button>
                        
                        <button wire:click="$set('advancedOrderFilter', 'lost_payments')" 
                                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-all <?php echo e($advancedOrderFilter === 'lost_payments' ? 'bg-indigo-600 text-white border-indigo-600 shadow-sm' : 'bg-white text-indigo-700 border-indigo-200 hover:bg-indigo-50'); ?>">
                            🤔 Kayıp Ödemeler (Yatmayanlar)
                        </button>
                        
                        <button wire:click="$set('advancedOrderFilter', 'underpaid')" 
                                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-all <?php echo e($advancedOrderFilter === 'underpaid' ? 'bg-red-600 text-white border-red-600 shadow-sm' : 'bg-white text-red-700 border-red-200 hover:bg-red-50'); ?>">
                            🚨 Eksik Yatanlar
                        </button>
                        
                        <button wire:click="$set('advancedOrderFilter', 'penalized')" 
                                class="px-3 py-1.5 rounded-full text-xs font-semibold border transition-all <?php echo e($advancedOrderFilter === 'penalized' ? 'bg-amber-500 text-white border-amber-500 shadow-sm' : 'bg-white text-amber-700 border-amber-200 hover:bg-amber-50'); ?>">
                            ⚠️ Cezalı İşlemler
                        </button>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    ...
                                    ?>
                                    <tr class="<?php echo e($order->is_flagged ? 'bg-red-50' : ($order->is_reconciled ? 'bg-gray-100 opacity-75' : ($isFuturePayment ? 'bg-gray-50 opacity-80 border-l-4 border-amber-400' : 'hover:bg-gray-50'))); ?>">
                                        <td class="px-3 py-3 text-center">
                                            <input type="checkbox" wire:model.live="selectedOrders" value="<?php echo e($order->id); ?>" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        </td>
                                        <td class="px-3 py-3">
                                            <div class="flex items-center gap-2">
                                                <div>
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->is_reconciled): ?>
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->erp_status === 'success'): ?>
                                                            <span title="ERP'ye İletildi" class="text-xs cursor-default">☁️</span>
                                                        <?php elseif($order->erp_status === 'pending' || $order->erp_status === 'retry'): ?>
                                                            <span title="ERP'ye Gönderilecek (Kuyrukta)" class="text-xs cursor-default animate-pulse">⏳</span>
                                                        <?php elseif($order->erp_status === 'failed'): ?>
                                                            <span title="ERP Hatası! Bknz: <?php echo e(Str::limit($order->erp_response, 100)); ?>" class="text-xs cursor-help">❌</span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                    <p class="text-xs text-gray-500"><?php echo e($order->order_date?->format('d.m.Y')); ?></p>
                                                </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFuturePayment): ?>
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-amber-100 text-amber-800" title="Vade Tarihi: <?php echo e(\Carbon\Carbon::parse($order->settlement->due_date)->format('d.m.Y')); ?>">
                                                        ⏳ Gelecek Vade
                                                    </span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        ...
                                        <td class="px-3 py-3 text-right text-sm font-medium <?php echo e($isFuturePayment ? 'opacity-50' : ''); ?>"><?php echo e(number_format($order->gross_amount, 2, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-right text-sm <?php echo e($isFuturePayment ? 'font-bold text-amber-600' : ''); ?>">
                                            <?php echo e(number_format($order->net_hakedis, 2, ',', '.')); ?> ₺
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFuturePayment): ?>
                                                <div class="text-[10px] text-amber-500 font-normal">Henüz Yatmadı</div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-3 py-3 text-right text-sm <?php echo e($isFuturePayment ? 'opacity-50' : ''); ?>"><?php echo e(number_format($order->commission_amount, 2, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-right text-sm <?php echo e($isFuturePayment ? 'opacity-50' : ''); ?>"><?php echo e(number_format($order->cargo_amount, 2, ',', '.')); ?> ₺</td>
                                        <td class="px-3 py-3 text-center">
                                            <button wire:click="showOrderDetail(<?php echo e($order->id); ?>)" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                                5N1K
                                            </button>
                                        </td>
                                    </tr>
        ...
        <?php elseif($activeTab === 'settings'): ?>
            <?php echo $__env->make('livewire.mp-settings-panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
