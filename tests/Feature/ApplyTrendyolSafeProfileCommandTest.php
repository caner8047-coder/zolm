...
class ApplyTrendyolSafeProfileCommandTest extends TestCase
{
    ...
    public function test_it_can_apply_safe_profile_to_single_trendyol_store(): void
    {
        $store = $this->createStore('trendyol', 'TY-CMD-ONE');
        ...
        $this->artisan('marketplace:apply-trendyol-safe-profile', [
            '--store' => $store->id,
        ])->assertExitCode(0);
        ...
        $this->assertSame(60, $profile->finance_poll_minutes);
        ...
        $this->assertSame(5, $profile->request_jitter_seconds);
    }
